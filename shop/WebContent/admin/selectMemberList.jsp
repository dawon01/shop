	...
	<table class="table table-dark table-striped" >
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-secondary"><%=m.getUpdateDate()%></td>
				<td class="text-secondary"><%=m.getCreateDate()%></td>
				<td>
					<!-- 특정회원의 등급을 수정 -->
					<a class="text-white" href="<%=request.getContextPath()%>/admin/updateMemberLevelForm.jsp?memberNo=<%=m.getMemberNo()%>">등급수정</a>
				</td>
			 	<td>
			 		<!-- 특정회원의 비밀번호를 수정 -->
			 		<a class="text-white" href="<%=request.getContextPath()%>/admin/updateMemberPwForm.jsp?memberNo=<%=m.getMemberNo()%>">비밀번호수정</a>
			 	</td>
			 	<td>
			 		<!-- 특정회원을 강제 탈퇴 -->
			 		<a class="text-white" href="<%=request.getContextPath()%>/admin/deleteMember.jsp?memberNo=<%=m.getMemberNo()%>">강제탈퇴</a>
			 	</td>
			</tr>
			<%	
			}
